...
import globeShadow from "../public/images/overGlobeShadow.png"
import globe from "/public/images/animatedGlobe.gif"
import Image from "next/image";
import UserPage from "@/components/widgets/UserPage";
    ...
    return (
        <>
            <main className={s.wrapper}>
                ...
                <Image className={s.leftGradientImg} src={leftGradient} alt={"left gradient"}/>
